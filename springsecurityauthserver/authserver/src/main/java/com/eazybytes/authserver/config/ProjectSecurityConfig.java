...
public class ProjectSecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient clientCredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                // ui applicationlar için useful olabilir .clientSettings(ClientSettings.builder().requireAuthorizationConsent(true).build())
                .build();
    ...
    //access tokenimize yeni bir field eklemek için bu beani kullanmaktayız
    @Bean
